...
/***********************************************************************************************/
  ...
  $sql = 'SELECT d.dmu_id lid,
                 d.b_date,
                 concat(date_format(d.b_date, "%Y%m%d"), lpad(d.dmu_id, 10, "0"))
                                                         AS b_date_fmt,
                 d.w_date,
                 concat(date_format(d.w_date, "%Y%m%d"), lpad(d.dmu_id, 10, "0"))
                                                         AS w_date_fmt,
          ...
          ORDER BY i.sdate_of_incident ASC, i.inc_id, d.dmu_id';
