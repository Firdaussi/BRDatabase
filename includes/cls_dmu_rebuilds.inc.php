<?php
  ...
  $sql = 'SELECT dc1.identifier       AS class1,
                 concat("locoqry.php?action=class&type=DMU&id=",dc1.dmu_class_id) AS class1_hl,
                 dcl1.dmu_id,
                 dcl1.dmu_class_id,
                 dcl1.start_date      AS sd1,
                 date_format(dcl1.start_date, "%Y%m%d") AS sd1_fmt,
                 dc2.identifier       AS class2,
                 concat("locoqry.php?action=class&type=DMU&id=",dc2.dmu_class_id) AS class2_hl,
                 dcl2.dmu_class_id,
