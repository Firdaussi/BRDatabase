...
//  echo $sql;
	...
	$tb_rep->add_column("tf_mirrlees",     "Time fitted with a Mirrlees engine", 11);
        $tb_rep->add_column("tf_ee",           "Time fitted with an E.E. engine", 11);
