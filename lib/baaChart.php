    ...
    ********************************************************/
    function baaChart ($awidth, $aheight=0, $pic='', $clip=0, $picx=0, $picy=0) {
        ...
        $this->scolors = array (
            ...
            2 => imagecolorallocate ($this->image,0x66,0xac,0x86),
            3 => imagecolorallocate ($this->image,0x99,0x00,0x99),
            4 => imagecolorallocate ($this->image,0xFF,0xCC,0x00),
            5 => imagecolorallocate ($this->image,0x17,0x32,0x19),
            6 => imagecolorallocate ($this->image,0x77,0x71,0x19),
            7 => imagecolorallocate ($this->image,0x16,0x82,0x19),
            8 => imagecolorallocate ($this->image,0xA5,0x10,0x19),
            9 => imagecolorallocate ($this->image,0x81,0xD3,0x19),
           10 => imagecolorallocate ($this->image,0x39,0x56,0x19),
           11 => imagecolorallocate ($this->image,0xFA,0x32,0x19),
           12 => imagecolorallocate ($this->image,0x99,0x32,0x19),
           13 => imagecolorallocate ($this->image,0x12,0x32,0x19),
           14 => imagecolorallocate ($this->image,0x64,0x32,0x19),
           15 => imagecolorallocate ($this->image,0xB5,0x32,0x19),
           16 => imagecolorallocate ($this->image,0X19,0x32,0x19),
           17 => imagecolorallocate ($this->image,0x01,0x32,0x19),
           18 => imagecolorallocate ($this->image,0x88,0x32,0x19),
           19 => imagecolorallocate ($this->image,0xC4,0x32,0x19),
           20 => imagecolorallocate ($this->image,0x90,0x32,0x19),
           21 => imagecolorallocate ($this->image,0x15,0x32,0x19),
           22 => imagecolorallocate ($this->image,0xE1,0x32,0x19),
           23 => imagecolorallocate ($this->image,0xA8,0x32,0x19),
           24 => imagecolorallocate ($this->image,0xF0,0x32,0x19),
           25 => imagecolorallocate ($this->image,0x33,0x32,0x19),
           26 => imagecolorallocate ($this->image,0x71,0x32,0x19),
           27 => imagecolorallocate ($this->image,0x44,0x32,0x19),
           28 => imagecolorallocate ($this->image,0x81,0x32,0x19),
           29 => imagecolorallocate ($this->image,0x10,0x32,0x19),
           30 => imagecolorallocate ($this->image,0xAA,0x32,0x19)
        );
        $this->tm = 50;
        $this->bm = 50;
        $this->lm = 80;
    ...
    ********************************************************/
    function _draw() {
        ...
        if ($this->pic == '') {
            ...
            imagefilledrectangle($this->image, $this->lm, $this->tm, $this->width-$this->rm, 
$this->height-$this->bm, $this->cbgd);
        }
        $this->stackcount=0;
    ...
    function pielegends() {
        ...
        foreach ($a as $pie) {
            ...
            case 1 : $this->legends[$pie] = sprintf("%-{$maxt}s %4.1f%%",$this->legends[$pie],$pc); 
              break;
            case 2 : $this->legends[$pie] = sprintf("%-{$maxt}s %{$maxv}s",$this->legends[$pie],$val); 
              break;
            case 3 : $this->legends[$pie] = sprintf("%-{$maxt}s %{$maxv}s %4.1f%%", $this->legends[$pie],$val,$pc);
              break;
            }
        }
    }
