...
class PHPGraphLib {
	...
	function addData($data, $data2 = '', $data3 = '', $data4 = '', $data5 = '') {
		...
		if (is_array($data)){ $this->data_array[]=$data; fwrite($fp, "Data 1\n"); }
		else
		  fwrite($fp, "Not an array: " . $data);
		if (is_array($data2)){ $this->data_array[]=$data2; fwrite($fp, "Data 2\n"); }
		if (is_array($data3)){ $this->data_array[]=$data3; fwrite($fp, "Data 3\n"); }
		if (is_array($data4)){ $this->data_array[]=$data4; fwrite($fp, "Data 4\n"); }
		if (is_array($data5)){ $this->data_array[]=$data5; fwrite($fp, "Data 5\n"); }
		//assess data
